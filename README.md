...
- `business_questions.md` — List of analytical questions being explored
...
2. Open `ecommerce_playground.ipynb` and run cells in order
3. Dataset files should be in the `datasets/` directory
